...
import ng.com.thewhitecellfoundation.haemcam.databinding.ChemodrugItemEndBinding
import ng.com.thewhitecellfoundation.haemcam.model.StringItemData

@ModelView(
    autoLayout = ModelView.Size.MATCH_WIDTH_WRAP_HEIGHT,
    defaultLayout = R.layout.chemodrug_item_end
)
class ChemoTherapyEndView @JvmOverloads constructor(
    context: Context,
    attr: AttributeSet? = null,
    defStyleAttr: Int = 0
) : ConstraintLayout(context, attr, defStyleAttr) {
    var binding: ChemodrugItemEndBinding = ChemodrugItemEndBinding.inflate(
